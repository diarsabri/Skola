function [u,elapsed_time_linsys]=generator(theta,plotsol)
% function u=generator(theta)
%
...
%    generator_2d_matlab.mat
% Download from: www.math.kth.se/~eliasj/sf1547/generator_2d_matlab.mat
% 
% Input: 
...
% The corresponding triangle indicesa
