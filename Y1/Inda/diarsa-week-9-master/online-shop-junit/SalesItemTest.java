...
public class SalesItemTest
{
    ...
    {
        SalesItem salesIte1 = new SalesItem("DS", 2);
        assertEquals(true, salesIte1.addComment("DS", "d", 2));
        assertEquals(true, salesIte1.addComment("SS", "d", 3));
        assertEquals(2, salesIte1.getNumberOfComments());
    }

    @Test
    public void authorMultipleComments()
    {
        SalesItem salesIte1 = new SalesItem("d", 2);
        assertEquals(true, salesIte1.addComment("d", "s", 2));
        assertEquals(false, salesIte1.addComment("d", "s", 3));
    }
    ...
    {
        SalesItem salesIte1 = new SalesItem("d", 2);
        assertEquals(false, salesIte1.addComment("dS", "d", 0));
        assertEquals(false, salesIte1.addComment("DD", "s", 6));
    }
}
