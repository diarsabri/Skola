...
def mlParams(X, labels, W=None):
    ...
    for jdx, classname in enumerate(classes):
        ...
        # Sigma - contains the covariance (diagonal matrix)
...
# Assignment 1 - Write & test mlParams
X, labels = genBlobs(centers=6)
mu, sigma = mlParams(X,labels)
plotGaussian(X,labels,mu,sigma)

# Assignment 2 - (I) Write & test computePrior. (II) Write & test classifyBayes.

#X, labels, pcadim = fetchDataset()
#print(computePrior(labels))

# Assignment 3 - All functions ready, run (I) testClassifier. (II) plotBoundary

#testClassifier(BayesClassifier(), dataset='iris')

#testClassifier(BayesClassifier(), dataset='vowel')

#plotBoundary(BayesClassifier())

# Assignment 4 - update mlParams to include weights

# Assignment 5 - (I) update computePrior to include weights. 
#                (II) design trainBoost function to implement Adaboost. 
#                (III) design classifyBoost function 

# Assignment 5.5 - testClassifier and compare to Assignment 3
#testClassifier(BoostClassifier(BayesClassifier(), T=10), dataset='iris',split=0.7)
#Trial: 0 Accuracy 100      #Trial: 10 Accuracy 97.8
#Trial: 20 Accuracy 93.3    #Trial: 30 Accuracy 93.3
#Trial: 40 Accuracy 97.8    #Trial: 50 Accuracy 86.7
#Trial: 60 Accuracy 93.3    #Trial: 70 Accuracy 95.6
#Trial: 80 Accuracy 93.3    #Trial: 90 Accuracy 95.6
#Final mean classification accuracy  94.2 with standard deviation 6.83

#testClassifier(BoostClassifier(BayesClassifier(), T=10), dataset='vowel',split=0.7)
#Trial: 0 Accuracy 68.8     #Trial: 10 Accuracy 77.9
#Trial: 20 Accuracy 77.3    #Trial: 30 Accuracy 70.1
#Trial: 40 Accuracy 68.8    #Trial: 50 Accuracy 68.2
#Trial: 60 Accuracy 77.3    #Trial: 70 Accuracy 70.8
#Trial: 80 Accuracy 71.4    #Trial: 90 Accuracy 82.5
